    ...
    def get_registration_plan(self):
        ...
        while remaining > 0:
            ...
            while count < 4 and len(available) > 0:
                ...
                course_idx = available.pop(best_course_index)

                semester.append(self.vertices[course_idx].label)
                processed[course_idx] = True
                remaining -= 1
                count += 1

                neighbors = self.get_adjacent_vertices(course_idx)
